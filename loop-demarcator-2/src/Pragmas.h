...
#ifndef CLANG_PLUGIN_EXAMPLES_LOOP_DEMARCATOR_2_PRAGMAS_H
#define CLANG_PLUGIN_EXAMPLES_LOOP_DEMARCATOR_2_PRAGMAS_H
...
class Pragmas {
private:
  std::map<const clang::FileEntry*, std::queue<unsigned>> lines;
...
public:
  void push(const clang::FileEntry* file, unsigned line);
  unsigned findNearestAndPop(const clang::FileEntry* file, unsigned lno);
};

#endif // CLANG_PLUGIN_EXAMPLES_LOOP_DEMARCATOR_2_PRAGMAS_H
