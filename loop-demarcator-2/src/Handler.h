...
#ifndef CLANG_PLUGIN_EXAMPLES_LOOP_DEMARCATOR_2_HANDLER_H
#define CLANG_PLUGIN_EXAMPLES_LOOP_DEMARCATOR_2_HANDLER_H
...
#endif // CLANG_PLUGIN_EXAMPLES_LOOP_DEMARCATOR_2_HANDLER_H
