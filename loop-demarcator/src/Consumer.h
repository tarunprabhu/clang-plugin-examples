...
#ifndef CLANG_PLUGIN_EXAMPLES_LOOP_DEMARCATOR_CONSUMER_H
#define CLANG_PLUGIN_EXAMPLES_LOOP_DEMARCATOR_CONSUMER_H
...
#endif // CLANG_PLUGIN_EXAMPLES_LOOP_DEMARCATOR_CONSUMER_H
